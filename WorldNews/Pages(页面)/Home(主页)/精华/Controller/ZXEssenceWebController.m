...
@interface ZXEssenceWebController ()<UIWebViewDelegate, UIScrollViewDelegate>
/** webView */
...
@implementation ZXEssenceWebController {
    CGFloat _offsetY;
}
/**
 *  构造方法
...
- (void)creatSuspendButton
{
    ...
    //创建悬浮按钮的window
    self.buttonWin = [[UIView alloc] initWithFrame:CGRectMake(20, 20, 54, 54)];
