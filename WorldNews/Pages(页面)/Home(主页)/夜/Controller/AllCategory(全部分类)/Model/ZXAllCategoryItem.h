...
@class ZXAllCategoryTopiclistItem,ZXAllCategoryTopiclistShareinfoItem;
@interface ZXAllCategoryItem : NSObject
...
@property (nonatomic, strong) NSArray<ZXAllCategoryTopiclistItem *> *topicList;

@end
@interface ZXAllCategoryTopiclistItem : NSObject
...
@property (nonatomic, strong) ZXAllCategoryTopiclistShareinfoItem *shareInfo;

@end

@interface ZXAllCategoryTopiclistShareinfoItem : NSObject
