...
#import "ZXAllCategoryController.h"
#import "ZXAllCategoryItem.h"
#import "ZXAllCategoryCell.h"
#import "ZXAllDetailCategoryController.h"
@interface ZXAllCategoryController ()
//全部分类数组
...
@implementation ZXAllCategoryController
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[ZXAllCategoryCell class] forCellWithReuseIdentifier:reuseIdentifier];
}
...
- (void)configNetManager
{
    ...
    [self.collectionView addHeaderRefresh:^{
        [NetManager GETAllCategory:1 completionHandler:^(ZXAllCategoryItem *allCategoryItem, NSError *error) {
    ...
    [self.collectionView addFooterRefresh:^{
        [NetManager GETAllCategory:self.pageNum + 1 completionHandler:^(ZXAllCategoryItem *allCategoryItem, NSError *error) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ZXAllCategoryCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
    ZXAllCategoryTopiclistItem *topicItem = self.categoryArr[indexPath.row];
...
{
    ZXAllCategoryTopiclistItem *topicItem = self.categoryArr[indexPath.row];
    ZXAllDetailCategoryController *detailCateVC = [[ZXAllDetailCategoryController alloc] initWithImageName:topicItem.imgUrl labelName:topicItem.title ID:topicItem.ID];
