...
@interface ZXCategoryController ()<UICollectionViewDelegateFlowLayout>
/** topicRecommend */
...
@implementation ZXCategoryController
...
- (void)configNetManager
{
    ...
    [self.tableView addHeaderRefresh:^{
        [NetManager GETCategoryItemCompletionHandler:^(ZXCategoryItem *cateItem, NSError *error) {
    ...
    [self.tableView registerClass:[ZXTopicCell class] forCellReuseIdentifier:@"ZXTopicCell"];
...
{
    ZXCategoryTopicrecommendlistItem *topicItem = self.topicRecommendArr[indexPath.row];
    ZXTopicCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ZXTopicCell" forIndexPath:indexPath];
...
{
    ZXAllCategoryController *cateVC = [[ZXAllCategoryController alloc] initWithCollectionViewLayout:[[ZXAllCategoryFlowLayout alloc] init]];
    //跳转时候隐藏tabBar
