...
@class XTJCommunity_retData,XTJCommunity_retData_pics;
@interface XTJCommunity : NSObject

@property (nonatomic,strong) NSString * msg;
@property (nonatomic,strong) NSString * code;
@property (nonatomic,strong) NSArray<XTJCommunity_retData *> * retData;

@end

@interface XTJCommunity_retData : XTJCommunity
...
@property (nonatomic, strong) NSArray<XTJCommunity_retData_pics *> * pics;

@end

@interface XTJCommunity_retData_pics : XTJCommunity_retData
