...
static NSString *const AccessKey = @"LTAIPTm5O09Ux42e";
static NSString *const SecretKey = @"pB0Yg26TG7vAxLifmqboGrPePQl9fK";
static NSString *const BucketName = @"51gongjiang";
