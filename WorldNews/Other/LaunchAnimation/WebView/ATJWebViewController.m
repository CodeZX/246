...
- (void)viewDidLoad {
    ...
    if ([statusBar respondsToSelector:@selector(setBackgroundColor:)]) {
        statusBar.backgroundColor = YGRGBColor(60 , 158, 243);
    }
    //添加进度条
...
-(UIBarButtonItem*)customBackBarItem{
    if (!_customBackBarItem) {
        UIImage* backItemImage = [[UIImage imageNamed:@"nav_back_icon"] imageWithRenderingMode:UIImageRenderingModeAutomatic];
        UIImage* backItemHlImage = [[UIImage imageNamed:@"nav_back_icon"] imageWithRenderingMode:UIImageRenderingModeAutomatic];
